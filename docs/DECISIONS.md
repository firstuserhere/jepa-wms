...
| 2026-08-25 | Box the exact training path on one 8xH200 node before scaling to 32 GPUs. | Two short runs must meet measured MFU, input-wait, memory, checkpoint, and W&B hardware-utilization gates; their checkpoints are observational and never promoted. |
